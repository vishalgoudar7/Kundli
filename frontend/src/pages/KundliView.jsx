...
import PanchangaPanel from '../components/PanchangaPanel.jsx';
...
export default function KundliView() {
  ...
  return <><div className="result-actions"><Link to="/dashboard"><ArrowLeft size={17}/> Back to My Kundlis</Link><div className="result-action-group"><a className="secondary-action" href="#panchanga">Panchanga</a><Link className="primary-action" to={`/kundli/${id}/edit`}><Pencil size={16}/> Edit</Link></div></div><KundliResult kundli={kundli} /><div className="panchanga-wrap"><PanchangaPanel panchanga={kundli?.result?.panchanga} /></div></>;
}
